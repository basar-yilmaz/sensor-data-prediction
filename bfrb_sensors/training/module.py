...
class BFRBClassificationModule(pl.LightningModule):
    ...
    def __init__(
        ...
        self.val_log_loss = MeanMetric()
        self.val_binary_precision = BinaryPrecision()
        self.val_binary_recall = BinaryRecall()
    ...
    def validation_step(self, batch: dict[str, torch.Tensor], batch_idx: int) -> None:
        ...
        self.val_log_loss.update(F.cross_entropy(logits, labels))
        self.val_binary_precision.update(binary_preds, binary_labels)
        self.val_binary_recall.update(binary_preds, binary_labels)
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        val_log_loss = self.val_log_loss.compute()
        val_binary_precision = self.val_binary_precision.compute()
        val_binary_recall = self.val_binary_recall.compute()
        ...
        self.log("val_log_loss", val_log_loss)
        self.log("val_binary_precision", val_binary_precision)
        self.log("val_binary_recall", val_binary_recall)
        ...
        self.val_log_loss.reset()
        self.val_binary_precision.reset()
        self.val_binary_recall.reset()
